...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const untils_1 = require("../scripts/animateResume/untils/untils");
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const untils_1 = require("./untils/untils");
const mobileEndAnimate_1 = require("./untils/mobileEndAnimate");
            ...
            const startLoad = () => {
                setTimeout(() => {
                    ...
                    if (num <= sum) {
                        ...
                        let nextInterval = untils_1.getInterval(str, interval);
...
function mobileEndAnimate(styleID, resumeID) {
    ...
    let preCssStr = Object.entries(preCss).map((v) => v.join(':')).join(';');
...
const ar = new index_1.default(container, {
